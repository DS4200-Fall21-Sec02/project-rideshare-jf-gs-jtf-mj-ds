	...
	return {
		...
		console.log(data.slice(0,10));
		 ...
		 var bar_color = d3
 			 ...
 			 .domain(['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'])
  			 .range(["#000000","#000000","#000000","#000000","#000000","#D3D3D3", "#000000" ]);
	    ...
	    svg1.append('g')
     	...
     	var bars = svg1.selectAll('.bar')
     		...
     		.enter().append('rect')
     		.attr('class', 'bar')
     		.attr('x', function(d) {return bar_xaxis(d.Weekday) + 10})
     		.attr('y', function(d) {
	    ...
	    svg2
	      ...
	      .enter()
	      .append("circle")
	      .filter(function(d) {return d.Weekday == 'Fri'})
	      .attr("id", (d) => d.id)
	      .attr("cx", function (d) {
